  ...
  <div class="dashboard-page">
    <section class="member-hero">
      <div>
        ...
        <p>会员卡有效期至 {{ profile.expireTime }}，可在这里维护基础资料和查看会员状态。</p>
      </div>
    ...
    <section class="content-grid">
      ...
      <div class="panel">
        ...
        <el-form :model="form" label-width="80px">
          ...
          <el-form-item label="新密码"><el-input v-model="password" type="password" show-password placeholder="演示保存，不提交后端" /></el-form-item>
        </el-form>
      </div>
    </section>
  </div>
